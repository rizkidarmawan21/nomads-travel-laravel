                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:180px;">
                                                                <img alt="MJML" height="auto"
                                                                    src="{{ url('frondend/images/logo@2x.png') }}"
        ...
        <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tbody>
                    <tr>
                        <td
                            style="border-bottom:1px dashed #eee;direction:ltr;font-size:0px;padding:20px 0;padding-bottom:20px;padding-top:20px;text-align:center;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    style="font-family:Assistant, serif;font-size:18px;line-height:28px;text-align:left;color:#071C4D;">
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                    style="color:#071C4D;font-family:Assistant, serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                                    <tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="center" bgcolor="#ff9e53" role="presentation"
                                                                style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#ff9e53;"
                                                                valign="middle">
                                                                <a href="{{ route('checkout', $data->id) }}"
                                                                    style="display:inline-block;background:#ff9e53;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:3px;">
                                                                    Check Detail </a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left"
                                                style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div
                                                    style="font-family:playfair Display, Times New Roman, serif;font-size:18px;font-weight:bold;line-height:1;text-align:left;color:#071C4D;">
                                                    Butuh Bantuan?</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    ...
                                                    2022 Nomads Copyright All Right Reserved.</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
